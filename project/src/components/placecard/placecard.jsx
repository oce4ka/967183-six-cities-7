...
function PlaceCard(props) {
  const {offer, onMouseEnter, onMouseLeave, isFavorites = '', showPremium = false} = props;

  return (
    <article className={`${isFavorites ? 'favorites__card' : 'cities__place-card'} place-card`} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
